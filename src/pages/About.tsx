      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-col md:flex-row gap-12 items-start">
          ...
          <div className="w-full md:w-1/3 shrink-0">
            <div className="aspect-[4/5] rounded-[2px] overflow-hidden mb-6 bg-[#e4eadf]">
              <img 
            ...
            <div className="bg-[#e4eadf] p-6 rounded-[2px] border border-zinc-200">
              <h3 className="font-bold uppercase tracking-wider text-zinc-900 mb-4 text-sm">Contact Info</h3>
              <ul className="space-y-4 text-zinc-500">
                <li className="flex items-center gap-3">
                  <Mail className="w-5 h-5 text-orange-600" />
                  <a href="mailto:BenWhiteIV@gmail.com" className="hover:text-orange-600 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-600 rounded-[2px] px-1 -ml-1">BenWhiteIV@gmail.com</a>
                </li>
                <li className="flex items-center gap-3">
                  <Phone className="w-5 h-5 text-orange-600" />
                  <a href="tel:+18046155220" className="hover:text-orange-600 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-600 rounded-[2px] px-1 -ml-1">(804) 615 - 5220</a>
                </li>
                <li className="flex items-center gap-3">
          ...
          <div className="w-full md:w-2/3">
            <h1 className="text-5xl md:text-6xl font-black uppercase tracking-tighter text-zinc-900 mb-2">
              Benjamin White
            </h1>
            <h2 className="text-2xl text-orange-600 font-serif italic mb-8">Photographer</h2>
            ...
            <div className="mb-12">
              <h3 className="text-2xl font-bold uppercase tracking-tight text-zinc-900 mb-6 border-b-2 border-zinc-200 pb-2">
            ...
            <div>
              ...
              <ul className="space-y-4 text-zinc-500">
                <li className="flex items-start gap-4">
                  <span className="font-bold text-zinc-900 w-1/3">HJ Holtz & Son</span>
                  <span className="w-2/3">Commercial and location photography showcasing premium contracting services.</span>
                </li>
                <li className="flex items-start gap-4">
                  <span className="font-bold text-zinc-900 w-1/3">Drive Shack</span>
                  <span className="w-2/3">High-energy event and lifestyle photography.</span>
                </li>
                <li className="flex items-start gap-4">
                  <span className="font-bold text-zinc-900 w-1/3">VA Repertory Theatre</span>
                  <span className="w-2/3">Promotional images and live performance capture.</span>
                </li>
                <li className="flex items-start gap-4">
                  <span className="font-bold text-zinc-900 w-1/3">Cava Co.</span>
